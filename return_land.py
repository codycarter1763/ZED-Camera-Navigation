...
# # ── MAVLink ───────────────────────────────────────────────────
# MAV_CONNECT  = '/dev/ttyACM0'    # First Pixhawk port for MAVLink
# MAV_BAUD     = 115200           # Match SERIAL2_BAUD in ArduPilot params
# GUIDED_MODE  = 4                 # ArduCopter GUIDED mode number
...
# # ── Gimbal config ─────────────────────────────────────────────
# GIMBAL_PORT  = '/dev/ttyACM2'    # Third Pixhawk port - gimbal!
# GIMBAL_BAUD  = 115200
